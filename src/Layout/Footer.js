                ...
                <div className="l-footer-row">
                    ...
                    <div className="l-footer-column taxly-footer-2">
                        <div className="footer-menu">
                            ...
                            <ul className="footer-menu__list">
                                <li>
                                    <NavLink onClick={scrolling} exact to="/api/">{t('footer.features.navLinkApi')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/social-impact/">{t('footer.features.navLinkCharity')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/insights/">{t('header.data.navLinkInsights')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/tax-accountants/">{t('footer.features.navLinkTaxAccountants')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/app/">{t('header.data.navLinkApp')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/de-taxcalculator/" rel="noopener">{t('footer.features.navLink2020Calculator')}</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="l-footer-column taxly-footer-3">
                        <div className="footer-menu">
                            ...
                            <ul className="footer-menu__list">
                                ...
                                <li>
                                    <NavLink onClick={scrolling} exact to="/faq/">{t('header.data.navLinkFaq')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/community/">{t('footer.resources.navLinkCommunity')}</NavLink>
                                </li>
                                <li>
                    ...
                    <div className="l-footer-column taxly-footer-4">
                        <div className="footer-menu">
                            ...
                            <ul className="footer-menu__list">
                                <li>
                                    <NavLink onClick={scrolling} exact to="/careers/">{t('footer.company.navLinkJoinTheTeam')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/privacy/">{t('footer.company.navLinkPrivacyPolicy')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/terms-of-service/">{t('footer.company.navLinkTermsOfService')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/contact-us/">{t('footer.company.navLinkContactUs')}</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={scrolling} exact to="/about-us/">{t('footer.company.navLinkAboutUs')}</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div>
